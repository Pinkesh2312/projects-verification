...
void client(vector<int> neighbouring_ports, vector<int> &sockfd, vector<string> required_files, vector<string> my_files)
{
...
int main(int argc, char const *argv[])
{
	...
	thread client_thread = thread(client, neighbour_ports, std::ref(sockfd), files, my_files);
